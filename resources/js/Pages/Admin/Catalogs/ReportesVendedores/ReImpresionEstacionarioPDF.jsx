...
export default function ReImpresionEstacionarioPDF({ data = selected, state }) {
    return (
        ...
        <View style={styles.section}>
                ...
                <View style={{ ...styles.page, gap: '4px' }}>
                    <View style={styles.div}>
                        ...
                        <View style={{ ...styles.divCol, alignItems: 'flex-end' }}>
                            <Text>{(data.lts_contado)}</Text>
                            <Text>{(data.lts_credito)}</Text>
                            <Text>{(data.lts_total)}</Text>
                        </View>
                    </View>
                </View>
            </View>
            <View style={{ ...styles.div, paddingLeft: '40px', right: '40px' }}>
                ...
                <View style={{ ...styles.page, gap: '4px', flexGrow: 1 }}>
                    <View style={styles.div}>
                        <View style={styles.divCol}>
                            <Text style={styles.bold}>Total a contado: </Text>
                            <Text style={styles.bold}>Total a crédito: </Text>
