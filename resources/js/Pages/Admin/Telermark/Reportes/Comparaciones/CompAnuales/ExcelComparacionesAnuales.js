...
export async function exportExcel(data, graph) {
    ...
    const origen = data.origenes.find((origen) => origen.idorigen === otherData.origen).descripcion
    ...
    worksheet = await generatTemplate(worksheet, workbook, `COMPARACION ${origen} ${mes.value.toUpperCase()} ${otherData.firstYear} ${mes.value.toUpperCase()} ${otherData.lastYear}`)
    ...
    workbook.xlsx.writeBuffer().then((data) => {
        ...
        a.href = url;
        a.download = `COMPARACIONES_${origen}_${mes.att.toUpperCase()}_${otherData.firstYear}_${otherData.lastYear}.xlsx`;
        a.click();
