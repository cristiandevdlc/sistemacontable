...
const ReportePDF = ({ data, estado, historial }) => {
    const date = new Date
            ...
            <Page size={"A4"} style={styles.page}>
                ...
                <View>
                    <View style={styles.dataContainer}>
                        ...
                        <Text style={styles.listItem}>Cambio de tanque: {!data.checkTanque ? "No" : "Si"}</Text>
                    ...
                    <Text style={styles.listItemDescripcion}>Descripción: {estado.obs ?? ""}</Text>
