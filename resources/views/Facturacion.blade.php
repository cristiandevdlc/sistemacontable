                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img class="adapt-img"
                                                                        src="data:image/png;base64,{{ base64_encode($empresa->empresa_Logotipo) }}"
                                                                        alt
                                                            ...
                                                            <tr>
                                                                <td align="center" class="es-m-txt-c"
                                                                    ...
                                                                    <h1
                                                                        ...
                                                                        {{ $empresa['empresa_razonComercial'] }}
                                                ...
                                                <tr>
                                                    <td class="esdev-mso-td" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;width:49px">
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" class="es-m-txt-c"
                                                                                ...
                                                                                <img src="https://eekgqni.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/50431617957498582.png"
                                                                                    alt
                                                                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                                    width="25">
                                                                            </td>
                                                    ...
                                                    <td class="esdev-mso-td" valign="top"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-right"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;width:501px">
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        width="100%" role="presentation"
                                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                        <tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" class="es-m-txt-c"
                                                                                style="padding:0;Margin:0;font-size:0px">
                                                                                <img src="https://eekgqni.stripocdn.email/content/guids/CABINET_3d0df4c18b0cea2cd3d10f772261e0b3/images/80951617957498354.png"
                                                                                    alt
                                                                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                                    width="25">
                                                                            </td>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="left" class="es-m-txt-l"
                                                                                ...
                                                                                <h3
                                                                                    style="Margin:0;line-height:24px;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-size:20px;font-style:normal;font-weight:bold;color:#333333">
                                                                                    Direccion:{{ $empresa->empresa_calle }},
                                                                                    {{ $empresa->empresa_numeroExterior }}
                                                                                    , {{ $empresa->empresa_localidad }},
                                                                                    {{ $empresa->empresa_codigoPostal }}
                                                                                </h3>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
