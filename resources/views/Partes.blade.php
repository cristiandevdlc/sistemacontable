                        ...
                        <div class="u-row"
                            ...
                            <div
                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div
                                        style="background-color: #f07711;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:24px;font-family:'Raleway',sans-serif;"
                                                            align="left">

                                                            <div class="v-text-align"
                                                                style="font-size: 42px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="line-height: 140%;"><strong>Intergas del
                                                                        norte</strong></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="{{ $base64Image1 }}" title="image"
                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 70%;"
                                                                            width="300"
                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div
                                        ...
                                        <div class="v-col-border"
                                            ...
                                            <table id="u_content_image_4" style="font-family:'Raleway',sans-serif;"
                                                role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                                border="0">
                                                <tbody>
                                                    <tr>
                                                            ...
                                                            <table width="100%" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="v-text-align"
                                                                        ...
                                                                        <div class="v-text-align"
                                                                            style="font-size: 40px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                            <p style="line-height: 140%;"><span
                                                                                    data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiaVppZVJ3elpVbXhzTkswWkZOMThraiIsInBhc3RlSUQiOjE2NjAxMjUwNzksImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;"
                                                                                    style="line-height: 70px;"></span><strong>{{ $Tipo }}</strong>
                                                                            </p>
                                                                        </div>

                                                                        <p style="line-height: 140%;"><span
                                                                                data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiaVppZVJ3elpVbXhzTkswWkZOMThraiIsInBhc3RlSUQiOjE2NjAxMjUwNzksImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;"
                                                                                style="line-height: 19.6px;"></span><strong>Nombre
                                                                                Unidad</strong>:
                                                                            {{ $UnidadNOMBRE->unidad_numeroComercial }}
                                                                        </p>
                                                                        <p style="line-height: 140%;">
                                                                            <strong>Operador</strong>:
                                                                            {{ $operadorObjeto->Nombres }}
                                                                            {{ $operadorObjeto->ApePat }}
                                                                            {{ $operadorObjeto->ApeMat }}
                                                                        </p>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="v-container-padding-padding"
                                                                                        ...
                                                                                        <div class="v-text-align"
                                                                                            style="font-size: 28px; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                                            <p
                                                                                                style="line-height: 140%;">
                                                                                                <span
                                                                                                    data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiaVppZVJ3elpVbXhzTkswWkZOMThraiIsInBhc3RlSUQiOjE2NjAxMjUwNzksImRhdGFUeXBlIjoic2NlbmUifQo=(/figmeta)--&gt;"
                                                                                                    style="line-height: 39.2px;"></span><span
                                                                                                    style="line-height: 39.2px;"></span><strong>
                                                                                                    {{ $asunto }}</strong>
                                                                                            </p>
                                                                                        </div>
                                                                        ...
                                                                        @foreach ($resultadosPartes as $key => $item)
