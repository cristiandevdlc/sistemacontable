        ...
        <table style="width:100%;height:78%; border-collapse: collapse;">
            ...
            <tr class="table-data">
                <td class="letracontainer" style="text-align: center">
                    <table>
                        <tr class="table-header">
                            <th style="text-align: center;width:20%">{{ $item->ITEM }}</th>
                            <th style="text-align: center;width:80%">{{ $item->unidad_numeroComercial }}</th>
                        </tr>
                    </table>
                </td>
                <td class="letracontainer" style="text-align: center">
                    <table>
                        <tr class="table-header">
                            <th style="text-align: center;width:50%">{{ number_format($item->kiloSalida, 4, '.', ',')  }}</th>
                            <th style="text-align: center;width:50%">{{ number_format($item->kiloEntrada, 4, '.', ',')  }}</th>
                            <th style="text-align: center;width:50%">{{ number_format($item->Kilometros_Recorridos, 4, '.', ',')  }}</th>
                        </tr>
                    </table>
                </td>
                ...
                <td class="letracontainer" style="text-align: center">
                    <table>
                        ...
                        <tr class="table-header">
                            <th style="text-align: center;width:50%">{{ $item->Gasolina_inicial }}</th>
                            <th style="text-align: center;width:50%">{{ $item->Gasolina_Final }}</th>
                        </tr>
